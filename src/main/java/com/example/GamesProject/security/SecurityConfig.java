package com.example.GamesProject.security;



import com.example.GamesProject.filters.CustomAuthenticationFilter;
import com.example.GamesProject.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                //.requestMatchers( POST."/api/users/games/{gameId}/**").permitAll()
